<?php
	/// IMPLEMENTACIÓN FACADES PARA OBTENER TODAS LAS SOLICITUDES
	class FacadesAllSolicitudes extends BaseController {
		public function getTipoUsuario ($idtipousuario) {
			return $this->getProyectos($idtipousuario);
		}
		
		public function getProyectos($idtipousuario) {
			...
			return $this->getRecorrerProyectos($proyectos);
		}

		public function getRecorrerProyectos($proyectos) {
	...
	class ProyectosController extends BaseController {
		...
		public function FacadeAllSolicitudes() {
			$idtipousuario = Auth::user()->tipo_usuario;
			$results = new FacadesAllSolicitudes($idtipousuario);
		}
