		...
		<div class="col-md-10 col-md-offset-1 text-left">
			...
			<form action="{{ URL::asset('confirma_proyecto_solicitud') }}" method="POST" class="form-vertical" role="form">
				...
				<input type="hidden" name="id_proyecto" id="id_proyecto" value="{{ $id }}">
					...
					<div class="form-group">
						<div class="col-sm-6">
							<h4><strong>Costo Calculado: $</strong>{{ $costo }}</h4>	
				  		</div>
				  		<div class="col-sm-6">
							<h4 style="color: green;"><strong>Costo Definido: $</strong>{{ $proyecto[0]->costo }}</h4>	
				  		</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
					...
					<?php if (Auth::user()->tipo_usuario == 2): ?>
						<div class="form-group">
						<div class="col-sm-6">
			  				<p class="help-block margin-bottom-cero"><strong>Definir Costo: </strong></p>
			  				<input type="text" class="form-control" placeholder="Definir Costo..." name="costoprov" id="costoprov" value="">
				  		</div>
					</div>
					<?php else: ?>
						<div class="form-group">
						<div class="col-sm-6">
			  				<p class="help-block margin-bottom-cero"><strong>Definir Costo: </strong></p>
			  				<input type="text" class="form-control disabled " placeholder="Definir Costo..." name="costoprov" id="costoprov" value="" disabled>
				  		</div>
					<?php endif ?>
