...
<div class="container">
	...
	<div class="row text-center">
		...
		<div class="col-md-10 col-md-offset-1 text-left">
						...
						<div class="col-sm-12">
							...
							<select class="form-control" name="recurso" id="recurso" data-val="recurso">
								...
								@foreach ($recursos as $r)
				              		<option value="{{ $r->id_recurso }}">{{ $r->actividad }} | Categoría: {{ $r->seniority }} | Nombre: {{ $r->nombre }}</option>
				            	@endforeach
							</select>
				  		</div>
					</div>
			...
			<h4>Costo actual y aproximado del proyecto: ${{ $costo }} </h4>
			<p></p><p>Recursos asignados</p>
